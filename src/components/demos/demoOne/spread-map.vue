                ...
                <div class="col-lg-6 offset-lg-6 col-xs-12">
                    <div class="who-we-contant">
                        <div class="dream-dots text-left fadeInUp" data-wow-delay="0.2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeInUp;">
                                <img src="@/assets/img/svg/section-icon-11.svg" alt="">
                            </div>
                            <h4 class="text-white fadeInUp" data-wow-delay="0.3s">Download Our Application</h4>
                            ...
                            <a class="btn dream-btn mt-30 fadeInUp mr-15" data-wow-delay="0.6s" href="#">
                                <img src="img/icons/google-play.png" alt="">Download Now
                            </a>
                            <a class="btn dream-btn mt-30 fadeInUp" data-wow-delay="0.6s" href="#">
                                <img src="img/icons/windows.png" alt="">Download Now
                            </a>
                    </div>
                </div>
