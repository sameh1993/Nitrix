<template>
    <section class="demo-video features section-padding-100"  style="background:url('@/assets/img/svg/bg_hero.svg') no-repeat center right">
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12">
                    <div class="services-block-four mt-s">
                        <div class="inner-box">
                            <div class="icon-img-box">
                                <img src="@/assets/img/icons/d1.png" alt="">
                            </div>
                    ...
                    <div class="services-block-four">
                        <div class="inner-box">
                            <div class="icon-img-box">
                                <img src="@/assets/img/icons/d2.png" alt="">
                            </div>
                    ...
                    <div class="services-block-four" style="margin-bottom:0">
                        <div class="inner-box">
                            <div class="icon-img-box">
                                <img src="@/assets/img/icons/d3.png" alt="">
                            </div>
